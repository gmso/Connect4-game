...
def make_board_won_with_column_of_reds():
    ...
    board.columns[2] = (
        make_column(["YELLOW", "YELLOW", "YELLOW", "RED", "", ""]))
    board.columns[3] = (
        make_column(["RED", "YELLOW", "YELLOW", "RED", "RED", "RED"]))
    board.columns[4] = make_column(["RED", "RED", "YELLOW", "RED", "", ""])
...
def make_board_won_with_column_of_yellows():
    ...
    board.columns[2] = (
        make_column(["YELLOW", "YELLOW", "YELLOW", "RED", "", ""]))
    board.columns[3] = (
        make_column(["RED", "YELLOW", "YELLOW", "YELLOW", "YELLOW", ""]))
    board.columns[4] = make_column(["RED", "RED", "YELLOW", "RED", "", ""])
...
def make_board_playing_with_full_columns():
    ...
    board.columns[0] = make_column(["RED", "", "", "", "", ""])
    board.columns[1] = (
        make_column(["YELLOW", "YELLOW", "YELLOW", "RED", "RED", "RED"]))
    board.columns[2] = make_column(["YELLOW", "", "", "", "", ""])
    board.columns[3] = make_column(["RED", "", "", "", "", ""])
    board.columns[4] = (
        make_column(["YELLOW", "YELLOW", "RED", "RED", "RED", "YELLOW"]))
    board.columns[5] = make_column(["RED", "", "", "", "", ""])
